...
- Six selectable 8-bit visual themes style the Main Screen and Player controller: Quiz Show, Western, Neon Sci-Fi, Arcane Fantasy, Monster Mash, and Celebration. A quiz has one default theme and each round can optionally override it.
